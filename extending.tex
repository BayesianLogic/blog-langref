...
and provide a constructor that takes a single \verb|List| argument.

By default, the \bl engine will look for user-defined functions in the package
\verb|blog.distrib|. In addition, it will look for user-defined functions under
...
\begin{blogcode}
fixed Real log10(Real val) = Log10Interp();
\end{blogcode}

Then \verb|log10| can be used just like any other built-in function, e.g.
