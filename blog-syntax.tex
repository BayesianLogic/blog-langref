...
\section{BLOG Grammar Definition}
...
opt_expression_list ::= expression_list:e 
  | 
  ;
...
tuple_set ::= 
  LBRACE expression_list:elst 
  FOR type_var_lst:vars COLON expression:e RBRACE
  | LBRACE expression_list:elst FOR type_var_lst:vars RBRACE
  ;


evidence_stmt ::= OBS evidence:e SEMI 
  ;
